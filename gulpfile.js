...
gulp.task('watch', function () {
  ...
  $.watch('./source/**/*.ejs', function() {
    gulp.start('layout');
  });
});

gulp.task('sequence', gulpSequence('clean', 'sass', 'babel', 'vendorJs', 'imageMin', 'layout'));

gulp.task('default', ['sass', 'babel', 'vendorJs', 'browserSync', 'imageMin', 'layout', 'watch']);
